export declare class ESXClientScaleform {
     ...
     * @param seconds
     */
    ShowBreakingNews(title: string, message: string, bottom: string, seconds: number): void
     ...
     * @param seconds
     */
    ShowFreemodeMessage(title: string, message: string, seconds: number): void
     ...
     * @param seconds
     */
    ShowPopupWarning(title: string, message: string, bottom: string, seconds: number): void

    /**
     * This function starts the traffic scaleform movie used in the campaign.
     * @param seconds
     */
    ShowTrafficMovie(seconds: number): void
...
declare class ESXClientScaleformUtils {
     ...
     * @param movie
     */
    RequestScaleformMovie(movie: string): void
}
