export declare class ESXStreaming {
     ...
     * @param callback
     */
    RequestAnimDict(animDict: string, callback?: Function): void
     ...
     * @param callback
     */
    RequestAnimSet(animSet: string, callback?: Function): void
     ...
     * @param callback
     */
    RequestModel(model: number | string, callback?: Function): void
     ...
     * @param callback
     */
    RequestNamedPtfxAsset(assetName: string, callback?: Function): void
     ...
     * @param callback
     */
    RequestStreamedTextureDict(textureDict: string, callback?: Function): void
     ...
     * @param callback
     */
    RequestWeaponAsset(weaponHash: number | string, callback?: Function): void
}
