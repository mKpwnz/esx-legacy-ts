...
export declare class ESXGame {
     ...
     * @param props
     */
    SetVehicleProperties(vehicle: number, props: ESXClientVehicleProps): void
     ...
     * @param callback
     */
    SpawnLocalObject(modelOrHash: number | string, coords: Coords, callback?: Function): void
     ...
     * @param callback
     */
    SpawnObject(modelOrHash: number | string, coords: Coords, callback?: Function): void
     ...
     * @param callback
     */
    Teleport(entity: number, coords: Coords, callback?: Function): void
...
declare class ESXGameUtil {
     ...
     * @param size
     */
    DrawText3D(coords: Coords, text: string, size: number): void
}
